...
class MyLSTM(nn.Module):
    def __init__(self, input_size, hidden_size):
        ...
        self.confidence_layer = nn.Linear(input_size+hidden_size+hidden_size, hidden_size)

        #r2 boost amplification
        self.boost_factor = nn.Linear(hidden_size,hidden_size)

        self.boost_dropout = nn.Dropout(0.3)
    ...
    def forward(self, x, h0=None, c0=None):
        ...
        for t in range(seq_len):
            ...
            # boost = torch.tanh(self.boost_factor(x[t]))
            boost = self.boost_dropout(torch.tanh(self.boost_factor(x[t])))
...
optimizer = optim.Adam(list(model.parameters())+list(ann_layer.parameters()), lr=0.001,weight_decay=1e-4)
